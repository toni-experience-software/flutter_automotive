...
class PropertyTypeMethodInterfaceBuilder {
  ...
  String get getterName =>
      "getProperty${type.name[0].toUpperCase()}${type.name.substring(1)}";
  String get setterName =>
      "setProperty${type.name[0].toUpperCase()}${type.name.substring(1)}";
  String get listenName =>
      "listenProperty${type.name[0].toUpperCase()}${type.name.substring(1)}";
                  ...
                  b
                    ..statements.addAll([
                      ...
                      BuilderUtil.ifElseStatement(
                        ...
                        refer((Exception).toString())
                            .newInstance([
                              literalString("Return type mismatch"),
                            ])
                            .thrown
                            .statement,
                      ),
          ...
          m
            ...
            ..body = Block(
              (b) =>
                  b
                    ..statements.addAll([
                      refer("listenProperty<${_returnTypeForProperty.symbol}>")
                          .call([
                            refer("propertyId"),
                            refer("areaId"),
                            refer("rate"),
